...
async function bal(one, two) {
 ...
 avtwo.circle()
 let pth = "abd.png"
 let img = await jimp.read("https://i.imgur.com/Wq9nxte.jpeg")

 img.resize(1080, 1350).composite(avone.resize(185,185), 77, 164).composite(avtwo.resize(235, 235), 500, 170);

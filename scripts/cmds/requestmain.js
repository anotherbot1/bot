       ...
       const p = getPrefix(event.threadID);
		...
		if (fs.existsSync(pendingIDsPath)) {
			...
			if (pendingIDs.includes(threadID)) {
				const pendingMsg = "Your request to use bot main cmds is already in pending.... \nPlease contact BOT OWNER for fast approval.\n\n https://www.facebook.com/zeroday.was.hacker\n\n also you can join ZERODAY support Box for help\n Type: /supportgc \nto join.";
